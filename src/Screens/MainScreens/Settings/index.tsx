...
const Settings = () => {
  ...
  //--------GetUserData handler----Start.
  const [triggerFtechUser, userData] = useLazyGetUsersQuery();
  ...
  const fetchUser = async () => {
    try {
      const response = await triggerFtechUser({}).unwrap();
      if (response) {
